...
{
    public class ProgressiveCollectionPrincipal
    {
        ...
        public decimal total_collection_principal { get; set; }
        public decimal total_principal_collection_previous_year { get; set; }
    }
}
